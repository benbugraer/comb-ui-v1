...
The essentials for this recipe are MagicUI [Dock Component](https://magicui.design/docs/components/dock) and AceternityUI [Link Preview](https://ui.aceternity.com/components/link-preview).
