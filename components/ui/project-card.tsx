...
export function ProjectCard({title, description, tags, image, video}: Props) {
    return (
        <Card
            className={
        ...
        >
            {video && (
                <video
                    ...
                    muted
                    playsInline
                    className="pointer-events-none mx-auto h-64 w-full object-cover object-top" // needed because random black line at bottom of video
                />
            )}
            {image && (
